...
namespace MatrixBackground
{
    class Engine
    {
        public static class Settings
        {
            ...
            private const int MIN_SPAWN_TIME_CHAR = 40;
            ...
            public static char RandomChar { get { return (char)Random.Next(32, 126); } }
            public static char RandomZeroOne { get { return Random.Next(0, 2).ToString()[0]; } }
